    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark">
      <div className="fixed max-w-[480px] mx-auto inset-x-0 top-0 z-50 bg-background-light dark:bg-background-dark shadow-sm">
        ...
        <div className="flex items-center p-4 pb-2 justify-between">
          ...
          <div className="flex flex-col items-center flex-1">
            <h2 className="text-lg font-bold leading-tight tracking-tight">SBCT - Curitiba</h2>
            <span className="text-xs text-[#4567a1] dark:text-gray-400 font-medium">Ref: 14:22Z</span>
          </div>
      ...
      <main className="mt-20 px-0 pb-32">
        <div className="flex flex-col">
          <h3 className="text-lg font-bold leading-tight tracking-tight px-4 pb-2 pt-4">METAR Decodificado (14:00Z)</h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 p-4">
            <WeatherTile icon="air" value="110° @ 08kt" label="Vento" />
            <WeatherTile icon="visibility" value="10km+" label="Visibilidade" />
            <WeatherTile icon="cloud" value="SCT 020" label="Nuvens (BKN 080)" />
            <WeatherTile icon="thermostat" value="21° / 14°C" label="Temp / Orvalho" />
            <WeatherTile icon="speed" value="1018 hPa" label="QNH / Altímetro" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-[10px] text-gray-500 italic flex items-center gap-1">
              ...
              Assinatura digital validada via servidor oficial (EGP).
            </p>
            <p className="text-[9px] text-gray-400 uppercase tracking-tighter">
              Logged by User: OBS-PR-9928 | Timestamp: 2023-10-22 14:23:45Z
            </p>
          </div>
        </div>
      </div>
